...
const locale = {
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR and MT5 are external trading interfaces that require local deployment of NEXTFlutus. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or MT5 terminal) on your local machine.',
  ...
  'agentTokens.description': 'Issue and manage tokens that let external AI agents (Cursor, Claude Code, Codex, MCP, custom bots) call this NEXTFlutus instance through /api/agent/v1.',
  ...
  'trading-assistant.editor.docsIntroDesc': 'These are the commonly used NEXTFlutus script strategy APIs and lifecycle hooks, so you can code and look up usage side by side.',
  ...
  'quickTrade.tpslRecordOnlyHint': 'Note: TP/SL prices are saved in NEXTFlutus trade records only. They are not sent to the exchange as native TP/SL or trigger orders. Set exchange-side TP/SL on the exchange if you need that.',
  ...
  'profile.exchange.openAccountPromo': 'NEXTFlutus exclusive signup — up to 20% commission rebate',
  ...
  'profile.exchange.localDeploymentHint': 'This broker requires local deployment of NEXTFlutus to use.',
  'profile.exchange.desktopBrokersDisabledTitle': 'IBKR / MT5 disabled on this server',
  'profile.exchange.desktopBrokersDisabledFallback': 'Deploy NEXTFlutus on your own machine or private server and install TWS, IB Gateway, or MetaTrader 5.',
