...
const locale = {
  ...
  'indicatorIde.applyAndVerifyHint': 'Reproduces the headline IS numbers on the same 70% training window the tuner used.',
  'indicatorIde.applyAndRunFullHint': 'Runs on your full selected window (includes the 30% out-of-sample holdout).',
